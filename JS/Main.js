...
containerPopularFood.addEventListener("click", buyFoodPlassClick);
...
function buyFoodPlassClick(e) {
    ...
    if (e.target.classList.contains("plus")) {
        ...
        if (myFoods.length === 0) {
            ...
            e.target.parentElement.children[1].classList.add("display");
        ...
        let idFood = e.target.parentElement.parentElement.parentElement.children[0];
        idFood = idFood.getAttribute("id");
        ...
        if (myFoods.length === 0) {
            ...
            e.target.parentElement.parentElement.children[1].classList.add("display");
...
function addFoodMinsFood(e) {
    ...
    if (
        ...
        if (findFood.numberFood === 0) {
            ...
            allBox.forEach((element) => {
                if (element.children[2].textContent === nameFood) {
                    let newNumber =
                        e.target.parentElement.parentElement.children[1].textContent;
...
containerGallery.addEventListener("click", plusFoodGallery);
...
function buyFoodGallery(e) {
    if (e.target.classList.contains("plus")) {
        ...
        let imgSrc =
            e.target.parentElement.parentElement.parentElement.parentElement.children[1].getAttribute(
                "src"
            );
...
//plusFoodGallery
function plusFoodGallery(e) {
    if (
        e.target.parentElement.classList.contains("plus") ||
        e.target.parentElement.classList.contains("plus_food")
    ) {
        //Check if the food array is in Local Storage?
    ...
    if (idFood !== null) {
        boxGalleryFood.forEach((element) => {
            ...
            if (idFood.includes(id)) {
                ...
                element.children[2].children[2].children[2].classList.remove(
                    "display_btn_new"
                );

                const foodfound = myFoods.find((element) => element.id === id);

                element.children[2].children[2].children[2].children[1].textContent =
                    foodfound.numberFood;
            } else {
                element.children[2].children[2].children[1].classList.remove("display");
                element.children[2].children[2].children[2].classList.add(
                    "display_btn_new"
                );
            }
        });
...
function addMinsFoodGallery(e) {
    ...
    if (e.target.classList.contains("test-plus")) {
        const newNum = e.target.parentElement.parentElement.children[1].textContent;
        const idValue =
            e.target.parentElement.parentElement.parentElement.parentElement.parentElement.children[0].getAttribute(
                "id"
            );
...
function loadnfoCountFood() {
    ...
    let GalleryFood = document.querySelectorAll(".box-Galley-food");
    ...
    const idFoods = JSON.parse(localStorage.getItem("idFoods"));
    const myFood = JSON.parse(localStorage.getItem("myFoods"));
    ...
    if (myFood !== null) {
        myFood.forEach((element) => {
            const idFood = element.id;

            GalleryFood.forEach((element) => {
                const idFoodGalery = element.children[0].getAttribute("id");

                if (idFoodGalery === idFood) {
                    element.children[2].children[2].children[1].classList.add("display");
                    element.children[2].children[2].children[2].classList.remove(
                        "display_btn_new"
                    );
